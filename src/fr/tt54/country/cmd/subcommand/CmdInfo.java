...
public class CmdInfo extends SubCommand {
    ...
    private static void sendInfosMessage(Country country, CommandSender sender) {
        ...
        sender.sendMessage("§aLevel: §2" + country.getLevel() + " (" + country.getLevelPoints() + "/" + CountryManager.getPointsToNextLevel(country.getLevel()) + ")");
        ...
        sender.sendMessage("§aAlly: §d" + allies.substring(1, allies.length() - 1));
        ...
        sender.sendMessage("§aEntente: §e" + ententes.substring(1, ententes.length() - 1));
